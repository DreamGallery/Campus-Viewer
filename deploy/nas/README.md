...
镜像：`dreamgallery/campus-r2-updater:20260922-cf2`，架构 `linux/amd64`。
...
更新器日志出现“更新完成”后，打开 https://viewer.hatsuboshi.xyz 检查章节、图片和语音。当前镜像已通过 Linux amd64/Python 3.12 下的 72 项回归测试、真实 ACB 解码、镜像启动检查和容器内 R2 只读连接验证；NAS 首次完整初始化需在该主机上验收。
